...
#tounfite
#curl -d 'username='$RANDOM'&submit= ÊÝÚíá' -X POST $HTTPSERV29 > $FreeServertmpa29  
...
#curl -d 'password='$PATH_J_XM'&submit=Login' -d 'Username='$PATH_J_XM1'&Password='$PATH_J_XM2'&addf1=ÊÝÚíá' -X POST $HTTPSERV28 > $FreeServertmpb28
...
PATH_J_XM1=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
PATH_J_XM2=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
curl -d 'password='$PATH_J_XM'&submit=Login' -d 'Username='$PATH_J_XM1'&Password='$PATH_J_XM2'&addf1=ÊÝÚíá' -X POST $HTTPSERV36 > $FreeServertmpb32
...
#PATH_J_XM1=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
#PATH_J_XM2=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
#curl -d 'password='$PATH_J_XM'&submit=Login' -d 'Username='$PATH_J_XM1'&Password='$PATH_J_XM2'&addf1= Activation ÊÃßíÏ ' -X POST $HTTPSERV40 > $FreeServertmpa40
...
#PATH_J_XM1=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
#PATH_J_XM2=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
#curl -d 'password='$PATH_J_XM'&submit=Login' -d 'Username='$PATH_J_XM1'&Password='$PATH_J_XM2'&addf1= Activation ÊÃßíÏ ' -X POST $HTTPSERV43 > $FreeServertmpa43
...
#PATH_J_XM1=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
#PATH_J_XM2=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
#curl -d 'password='$PATH_J_XM'&submit=Login' -d 'Username='$PATH_J_XM1'&Password='$PATH_J_XM2'&addf1= Activation ÊÃßíÏ ' -X POST $HTTPSERV46 > $FreeServertmpa46
...
#PATH_J_XM1=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
#PATH_J_XM2=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
#curl -d 'password='$PATH_J_XM'&submit=Login' -d 'Username='$PATH_J_XM1'&Password='$PATH_J_XM2'&addf1= Activation ÊÃßíÏ ' -X POST $HTTPSERV47 > $FreeServertmpa47
...
#PATH_J_XM1=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
#PATH_J_XM2=$(echo "$((1000 + RANDOM % 9999))$((RANDOM % 9999))")
#curl -d 'password='$PATH_J_XM'&submit=Login' -d 'Username='$PATH_J_XM1'&Password='$PATH_J_XM2'&addf1= Activation ÊÃßíÏ ' -X POST $HTTPSERV48 > $FreeServertmpa48
...
#curl -H "Accept-Charset: utf-8" -H "Content-Type: application/x-www-form-urlencoded" -d 'username=0122&password=0122&submit= ÊÓÌíá ÇáÏÎæá ' -X POST http://cccam.ugeen.live/ugeen/Login.php > $FreeServertmpa50 
#sed -ne '/C:/ p' $FreeServertmpa20 > $FreeServertmpb20
#cat $FreeServertmpb20 >> $FreeServer2
#smart4k                   
